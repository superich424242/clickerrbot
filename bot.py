...
# ========== ТОКЕН (ВСТАВЛЕН) ==========
BOT_TOKEN = "8981424648:AAFDSu9LVH9DQTKqDIsjQ_6zZquDwtaWjb0"  # ⚠️ ЗАМЕНИ НА НОВЫЙ, ЕСЛИ ОТЗОВЁШЬ
...
@dp.message(lambda msg: msg.text == "🐣 КЛИК (1 сек)")
...
@dp.message(lambda msg: msg.text == "🏪 Магазин статусов")
...
@dp.message(lambda msg: msg.text == "📊 Топ 10")
...
@dp.message(lambda msg: msg.text == "🔄 Сброс")
